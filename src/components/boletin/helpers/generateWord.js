import { TabStopType, PageBorderZOrder, Header, VerticalAlign, Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell, WidthType, AlignmentType, BorderStyle, ImageRun, PageBorderDisplay, PageBorderOffsetFrom } from "docx";


export const fetchImageAsArrayBuffer = async (url) => {
    const response = await fetch(url);
    return await response.arrayBuffer();
};

export const generateBoletaWord = async (boleta, docente, membretePath, fontSizeTitle, fontSize, starImg) => {
    ...
    doc.addSection({
        ...
        properties: {
            ...
            page: {
                ...
                size: {
                    width: 11906, // tamaño carta ancho (8.5 pulgadas)
                    height: 16838, // tamaño carta alto (11 pulgadas)
                },
                            ...
                            new TableCell({
                                children: [
                                    ...
                                    new Paragraph({
                                        ...
                                        new ImageRun({
                                            data: starImg, // La imagen debe estar en Buffer o Base64
                                            transformation: {
